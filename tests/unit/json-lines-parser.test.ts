...
describe('JsonLinesParser', () => {
  ...
  describe('parsing valid JSONL', () => {
    ...
    it('should handle incomplete lines across chunks', (done) => {
    ...
    it('should handle data without trailing newline in flush', (done) => {
  ...
  describe('error handling', () => {
    ...
    it('should continue parsing after invalid line', (done) => {
      const input = '{"valid":1}\n{invalid json}\n{"valid":2}\n';
      const results: any[] = [];
      let errorCount = 0;
  ...
  describe('edge cases', () => {
    ...
    it('should handle Unicode characters correctly', (done) => {
    ...
    it('should handle escaped characters in JSON', (done) => {
